...
yourself. The files all begin interval0 - which is the internal name given to this
spectum. The files interval0pc.pi and/or interval0wt.pi are those which were
...
If you use the interval0[wt|pc].pi files, Xspec will look for the back.pi and
